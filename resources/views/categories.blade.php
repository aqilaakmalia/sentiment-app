			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="/categories"><i class="fa fa-angle-right" aria-hidden="true"></i>Categories</a></li>
					</ul>
				</div>
				...
				<div class="container">
					<div class="category-tag text-center">Categories</div>
					<!-- Categories -->
							...
							<div class="category-grid">
								@foreach ($categories as $category)
									...
									<div class="category-item">
										<a href="/product/{{ $category->id_category }}" class="category-link">
